...
const dataset: Pokemon[] = [
  { id: 1, nameKo: "이상해씨", nameEn: "bulbasaur", generation: 1, types: ["grass", "poison"], acceptedAnswers: ["이상해씨"] },
  { id: 4, nameKo: "파이리", nameEn: "charmander", generation: 1, types: ["fire"], acceptedAnswers: ["파이리"] },
  { id: 25, nameKo: "피카츄", nameEn: "pikachu", generation: 1, types: ["electric"], acceptedAnswers: ["피카츄"] },
  { id: 152, nameKo: "치코리타", nameEn: "chikorita", generation: 2, types: ["grass"], acceptedAnswers: ["치코리타"] },
];
