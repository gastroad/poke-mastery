...
export const CHALLENGES: ChallengeDef[] = [
  {
    ...
    rule: { mode: "name-guess", pool: { generations: [1] }, questionCount: 10 },
    unlock: { kind: "always" },
  },
  {
    id: "kanto-marathon",
    ...
    rule: { mode: "name-guess", pool: { generations: [1] }, questionCount: 20 },
  ...
  },
  {
    ...
    rule: { mode: "name-guess", pool: { generations: [1], types: ["fire"] }, questionCount: 10 },
  ...
  },
  {
    ...
    rule: { mode: "name-guess", pool: { generations: [1], types: ["water"] }, questionCount: 10 },
